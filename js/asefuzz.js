...
function drawNodes(g, d, simulation) {
    ...
    nodes.append("ellipse")
        ...
        .attr("class", function (d) {
            switch (d.color) {
                case "blackbox":
                    return "node node-blackbox";
                case "whitebox":
                    return "node node-whitebox";
                default:
                    return "node node-greybox";
            }
        })
        .on("click", onClick)
        .call(d3.drag()
    ...
    nodes.append("text")
        .attr("class", function (d) {
            switch (d.color) {
                case "blackbox":
                    return "nodetext nodetext-blackbox";
                default:
                    return "nodetext";
            }
        })
